...
public class WorkloadDAO {
	...
	public List<DBSizeTabelaVO> getDBSizeTabela(String mesRelatorio, Integer graficoID){
		...
		try {
			while (rs.next()) {
				...
				temp.setMesA(rs.getString("data_mes"));
				temp.setValorA(rs.getString("valor"));
				retorno.add(temp);
			}
		} catch (SQLException e) {
			// TODO Auto-generated catch block
	...
	private List<GraficoVO> getGraficos(Integer idInstancia) {
		...
		try {
			while (rs.next()) {
				temp = new GraficoVO();
				temp.setTituloDisplayName(rs.getString("titulo"));
				temp.setDescricaoAntes(rs.getString("descricao"));
				temp.setOrdemPlot(rs.getInt("mes_ano"));
				temp.setTipoPeriodoId(rs.getInt("tipo_calculo_id"));
				temp.setGraficoId(rs.getInt("grafico_controle_id"));
				temp.setTipoPeriodoId(rs.getInt("tipo_grafico_id"));
				temp.setCapitulo((String) rs.getObject("capitulo"));
				grafico.add(temp);
			}
		} catch (SQLException e) {
			// TODO Auto-generated catch block
...
//				temp.set(rs.getString("instancia"));
...
//				temp.setInstancia(rs.getString("instancia"));
	...
	public List<HostVO> getHosts(Integer idCliente, Integer capitulo) {
		...
		try {
			while (rs.next()) {
				temp = new HostVO();
				temp.setDisplayName(rs.getString("nome_fantasia"));
				temp.setId(rs.getInt("host_id"));
//				temp.set(rs.getString("descricao"));
				temp.setNome(rs.getString("hostname"));
